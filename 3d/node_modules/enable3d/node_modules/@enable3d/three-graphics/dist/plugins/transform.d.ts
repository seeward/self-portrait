import { Geometry, BufferGeometry, Vector3, Shape, Vector2, WebGLRenderer, PerspectiveCamera, OrthographicCamera, Raycaster, Mesh } from '@enable3d/three-wrapper/dist/index';
/**
...
export default class Transform {
    ...
    geometryToBufferGeometry(geometry: Geometry | BufferGeometry): BufferGeometry;
    bufferGeometryToGeometry(bufferGeometry: Geometry | BufferGeometry): Geometry;
    /**
     * Transforms your svg files to paths.
     */
    fromSVGtoShape(svg: string, isCCW?: boolean, noHoles?: boolean): Shape[];
