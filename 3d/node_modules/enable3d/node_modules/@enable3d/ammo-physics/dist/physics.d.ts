...
import { Vector3, Quaternion, Scene, Euler, Matrix4 } from '@enable3d/three-wrapper/dist/index';
...
declare class AmmoPhysics extends EventEmitter {
    ...
    get add(): {
        ...
        existing: (object: ExtendedObject3D, config?: Types.AddExistingConfig | undefined) => any;
    ...
    addRigidBodyToWorld(object: ExtendedObject3D, rigidBody: Ammo.btRigidBody, collisionFlags: number, collisionGroup: number, collisionMask: number, breakable: boolean, offset?: {
        x?: number;
        y?: number;
        z?: number;
    }): void;
    finishCollisionShape(collisionShape: Ammo.btCollisionShape, pos: Vector3, quat: Quaternion, scale: Vector3, margin: number): Ammo.btTransform;
