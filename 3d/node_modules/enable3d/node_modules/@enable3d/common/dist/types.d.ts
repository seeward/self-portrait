 ...
 */
import { MeshStandardMaterialParameters, MeshBasicMaterialParameters, MeshPhongMaterialParameters, LineBasicMaterialParameters, PointsMaterialParameters, MeshNormalMaterialParameters, PerspectiveCamera, OrthographicCamera, Shape, MeshLambertMaterialParameters, Texture, MeshToonMaterialParameters, MeshPhysicalMaterialParameters, Material, WebGLRenderer, Quaternion } from '@enable3d/three-wrapper/dist/index';
import { ExtendedObject3D } from './extendedObject3D';
import { ExtendedMesh } from './extendedMesh';
export { ExtendedObject3D };
export { ExtendedMesh };
export { AnimationMixer, AnimationClip, AnimationAction, Object3D, Mesh, Material, Line, Points, Group } from '@enable3d/three-wrapper/dist/index';
...
export interface ExtrudeConfig extends GeometryConfig, XYZ {
    shape: Shape;
    autoCenter?: boolean;
}
...
export declare type CustomCompoundShape = {
    shape: string;
    [property: string]: any;
}[];
