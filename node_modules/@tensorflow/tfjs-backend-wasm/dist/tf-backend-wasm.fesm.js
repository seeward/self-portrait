 ...
 * =============================================================================
 */
import { _FusedMatMul, util, Abs, backend_util, Add, AddN, Identity, Transpose, ArgMax, AvgPool, Reshape, BatchMatMul, Cast, ClipByValue, slice_util, buffer, Concat, Conv2D, Conv2DBackpropInput, Cos, CropAndResize, Cumsum, DepthToSpace, DepthwiseConv2dNative, Equal, Exp, ExpandDims, Fill, FlipLeftRight, Floor, FloorDiv, FusedBatchNorm, FusedConv2D, FusedDepthwiseConv2D, GatherNd, gather_util, GatherV2, Greater, GreaterEqual, LeakyRelu, Less, LessEqual, Log, LogicalAnd, Max, Maximum, MaxPool, Mean, Min, Minimum, Multiply, Neg, NonMaxSuppressionV3, NonMaxSuppressionV4, NonMaxSuppressionV5, NotEqual, OneHot, OnesLike, Pack, PadV2, Pow, Prelu, Prod, Range, RealDiv, Relu, Relu6, ResizeBilinear, Reverse, RotateWithOffset, Round, Rsqrt, ScatterNd, scatter_util, Select, Sigmoid, Sin, Slice, Softmax, SplitV, Sqrt, Square, SquaredDifference, Step, StridedSlice, Sub, Sum, Tanh, Tile, TopK, Unpack, ZerosLike, registerKernel, env, KernelBackend, DataStorage, engine, deprecationWarn, registerBackend } from '@tensorflow/tfjs-core';
...
const equalConfig = createBinaryKernelConfig(Equal, supportsFullBroadcast$1, 'bool');
...
const floorDivConfig = createBinaryKernelConfig(FloorDiv, supportsFullBroadcast$2);
...
const greaterConfig = createBinaryKernelConfig(Greater, supportsFullBroadcast$3, 'bool');
...
const greaterEqualConfig = createBinaryKernelConfig(GreaterEqual, supportsFullBroadcast$4, 'bool');
...
const lessEqualConfig = createBinaryKernelConfig(LessEqual, supportsFullBroadcast$6, 'bool');
...
const logicalAndConfig = createBinaryKernelConfig(LogicalAnd, supportsFullBroadcast$7, 'bool');
...
const maximumConfig = createBinaryKernelConfig(Maximum, supportsFullBroadcast$8);
...
const minimumConfig = createBinaryKernelConfig(Minimum, supportsFullBroadcast$9);
...
const multiplyConfig = createBinaryKernelConfig(Multiply, supportsFullBroadcast$a);
...
const notEqualConfig = createBinaryKernelConfig(NotEqual, supportsFullBroadcast$b, 'bool');
...
function pack(args) {
    ...
    const expandedTensors = inputs.map(t => expandDims({ inputs: { input: t }, backend, attrs: { dim: axis } }));
...
const powConfig = createBinaryKernelConfig(Pow, supportsFullBroadcast$c);
...
const realDivConfig = createBinaryKernelConfig(RealDiv, supportsFullBroadcast$d);
...
const squaredDifferenceConfig = createBinaryKernelConfig(SquaredDifference, supportsFullBroadcast$e);
...
const subConfig = createBinaryKernelConfig(Sub, supportsFullBroadcast$f);
...
export { BackendWasm, setWasmPath, setWasmPaths, version as version_wasm };
