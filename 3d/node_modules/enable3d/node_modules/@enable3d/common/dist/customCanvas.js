 ...
 */
const customCanvas = (customCanvasConfig = {}) => {
    ...
    if (parent)
        ...
        console.error(`[enable3d] parent "${p}" not found!`);
    ...
    const webgl = index_1.WEBGL.isWebGL2Available() ? 'webgl2' : 'webgl';
    // create context
