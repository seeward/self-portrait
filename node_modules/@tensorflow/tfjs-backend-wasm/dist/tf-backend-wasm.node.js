...
var perf_hooks = _interopDefault(require('perf_hooks'));
...
function pack(args) {
    ...
    var expandedTensors = inputs.map(function (t) { return expandDims({ inputs: { input: t }, backend: backend, attrs: { dim: axis } }); });
    return concat({ inputs: expandedTensors, backend: backend, attrs: { axis: axis } });
}
var packConfig = {
