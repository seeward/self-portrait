 ...
 */
import { Engine, Runner, Body, Render, Vector } from 'matter-js';
...
export declare class Physics {
    ...
    private _addBody;
    get add(): {
        body: (body: Body | Body[] | import("matter-js").Composite | import("matter-js").Composite[] | import("matter-js").Constraint | import("matter-js").Constraint[] | import("matter-js").MouseConstraint) => void;
        bodyToSprite: (sprite: SimpleSprite) => void;
        fromVertices: (x: number, y: number, vertexSets: Vector[][], options?: import("matter-js").IBodyDefinition) => Body;
        circle: (x: number, y: number, radius: number, options?: import("matter-js").IBodyDefinition) => Body;
        existing: (sprite: SimpleSprite) => void;
        rectangle: (x: number, y: number, width: number, height: number, options?: import("matter-js").IBodyDefinition) => Body;
    };
